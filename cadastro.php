        ...
        <div class="form-group">
          <div class="row">
            <div class="col">
              ...
              <small class="text-muted"> - Obrigatório</small>
              <input type="date" id="data_nasc_client" class="form-control need-validate onlyNumber" placeholder="01/12/2001" maxlength="14" required />
              <div class="invalid-feedback">
        ...
        <div class="form-group">
          <div class="row">
            <div class="col">
              ...
              <small class="text-muted"> - Obrigatório</small>
              <input type="text" id="phone" class="form-control onlyNumber need-validate" placeholder="(00)0000-0000" maxlength="13" required />
              <div class="invalid-feedback">
